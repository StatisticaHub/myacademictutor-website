...
function initSearch() {
  ...
  request.open('GET', '/myacademictutor-website/learning-hub/ml-biostatistics-course/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/myacademictutor-website/learning-hub/ml-biostatistics-course/assets/css/just-the-docs-' + theme + '.css');
}
